...
describe("Test Cases for Contact Component", () => {
  ...
  test("Should check if Submit button is present in Contact Component", () => {
    render(<Contact />);
  ...
  test("Should check if Message placeholder is present in Contact Component", () => {
    render(<Contact />);
  ...
  test("Should check if there are 2 input boxes present in Contact Component", () => {
    //RENDER
    render(<Contact />);
